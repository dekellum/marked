...
fn init_tag_metadata() -> HashMap<LocalName, TagMeta> {
    ...
    tag_meta.insert(
        ...
        TagMeta {
            is_inline: true,
            basic_attrs: vec![a::BASE, a::DIR, a::LANG, a::TITLE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        ...
        TagMeta {
            is_empty: true,
            basic_attrs: vec![a::ALT, a::BASE, a::DIR, a::LANG, a::MEDIA, a::TITLE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        ...
        TagMeta {
            is_inline: true,
            basic_attrs: vec![a::BASE, a::DIR, a::LANG, a::SRC, a::TITLE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        t::BLOCKQUOTE,
        TagMeta {
            basic_attrs: vec![a::BASE, a::CITE, a::DIR, a::LANG, a::TITLE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        ...
        TagMeta {
            is_empty: true,
            basic_attrs: vec![a::BASE, a::TITLE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        ...
        TagMeta {
            is_empty: true,
            basic_attrs: vec![a::BASE, a::DIR, a::LANG, a::SPAN, a::TITLE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        ...
        TagMeta {
            is_inline: true,
            basic_attrs: vec![a::BASE, a::DIR, a::LANG, a::TITLE, a::VALUE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        ...
        TagMeta {
            is_inline: true,
            basic_attrs: vec![a::BASE, a::CITE, a::DATETIME, a::DIR, a::LANG, a::TITLE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        ...
        TagMeta {
            ...
            is_deprecated: true,
            is_banned: true,
            basic_attrs: vec![a::BASE, a::SRC, a::TITLE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        ...
        TagMeta {
            is_meta: true,
            basic_attrs: vec![a::BASE, a::DIR, a::LANG],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        ...
        TagMeta {
            is_inline: true,
            basic_attrs: vec![a::ALIGN, a::BASE, a::TITLE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        ...
        TagMeta {
            ...
            is_inline: true,
            is_banned: true,
            basic_attrs: vec![a::ACCEPT, a::ALT, a::BASE, a::DIR, a::LANG, a::TITLE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        ...
        TagMeta {
            is_banned: true,
            basic_attrs: vec![a::BASE, a::DIR, a::LABEL, a::LANG, a::TITLE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        ...
        TagMeta {
            is_empty: true,
            basic_attrs: vec![a::BASE, a::NAME, a::VALUE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
        ...
        TagMeta {
            is_inline: true,
            basic_attrs: vec![a::BASE, a::DIR, a::HEIGHT, a::LANG, a::TITLE, a::WIDTH],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        ...
        TagMeta {
            is_empty: true,
            basic_attrs: vec![a::BASE, a::DIR, a::LANG, a::SRC, a::TITLE, a::TYPE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        t::TABLE,
        TagMeta {
            basic_attrs: vec![a::ALIGN, a::BASE, a::DIR, a::LANG, a::SUMMARY, a::TITLE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
        t::TBODY,
        TagMeta {
            basic_attrs: vec![a::ALIGN, a::BASE, a::DIR, a::LANG, a::TITLE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
    ...
    tag_meta.insert(
        ...
        TagMeta {
            is_inline: true,
            basic_attrs: vec![a::BASE, a::DATETIME, a::DIR, a::LANG, a::TITLE],
            ..TagMeta::default()
        },
    );
    tag_meta.insert(
