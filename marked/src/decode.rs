...
use tendril::{Atomicity, NonAtomic, Tendril, TendrilSink};

mod encoding_hint;

pub use encoding_hint::{EncodingHint, SharedEncodingHint};
    ...
    A: Atomicity,
{
    ...
    pub fn read_to_end<R>(mut self, r: &mut R) -> Result<Sink::Output, io::Error>
    where
        Self: Sized,
        R: io::Read,
    {
